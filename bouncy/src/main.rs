use bevy::{
  diagnostic::{DiagnosticsStore, FrameTimeDiagnosticsPlugin}, ecs::entity, platform::collections::{HashMap, HashSet}, prelude::*
};
...
fn setup(
  ...
  commands.insert_resource(StaticQuadTree::new(Vec2::new(1024.0, 768.0), QUAD_TREE_DEPTH));
...
fn collisions(
  ...
  let tree_positions: Vec<(Entity, usize, Rect2D)> = query.iter()
